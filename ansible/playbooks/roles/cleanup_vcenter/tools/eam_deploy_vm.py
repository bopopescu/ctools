...
def CreateAgencyConfig(si, args, scope):
    ...
    dc = _find_obj(content,content.rootFolder, 'dc' , {'name' : datacenter})
    clusters = get_obj_list(content,dc,'cluster')
