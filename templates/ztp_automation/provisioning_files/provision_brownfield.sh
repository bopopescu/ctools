...
sshpass -p "c0ntrail123" scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null root@10.87.70.9:/root/ztp-auto-files/provisioning_files/ztp_prod_command_servers.yml /root/command_servers.yml
sshpass -p "c0ntrail123" scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null  root@10.87.70.9:/root/ztp-auto-files/provisioning_files/ztp_prod_instances.yml /root/instances.yml
